            ...
            <div class="main-content">
                        ...
                        <?php foreach ($files as $file): ?>
                            <div class="file-item" onclick="<?php echo $file['is_directory'] ? "changeDirectory('" . rtrim($_SESSION['current_directory'], '/') . '/' . $file['name'] . "')" : "getFileInfo('" . addslashes($file['name']) . "')"; ?>">
                                ...
                                <div class="file-actions">
                                    ...
                                    <form method="POST" style="display: inline;" onsubmit="event.stopPropagation(); return confirmDelete('<?php echo addslashes($file['name']); ?>', <?php echo $file['is_directory'] ? 'true' : 'false'; ?>)">
                ...
                <div class="sidebar">
                    ...
                    <div style="margin-top: 30px;">
                        ...
                        <p>iFastNet's current File Manager is not great. This File Manager was created to address its shortcomings.</p>
                        <br>
